...
if( class_exists( 'Kirki' ) ) {
    function wpcap_b4_colors_section( $wp_customize ) {
        $wp_customize->get_control( 'background_color' )->label = esc_html__( 'Body Background Color', 'wpcap-b4' );
        $wp_customize->get_section( 'colors' )->title = esc_html__( 'Theme Colors', 'wpcap-b4' );
    }
    add_action( 'customize_register', 'wpcap_b4_colors_section' );
}

WPCAP_B4_Kirki::add_field( 'wpcap_b4_theme', array(
	'settings' => 'styling_header_bg_color',
	'label'    => esc_html__( 'Header Background Color', 'wpcap-b4' ),
	'section'  => 'colors',
	'type'     => 'color',
    'default'  => '#343a40',
    'output'   => array(
...
WPCAP_B4_Kirki::add_field( 'wpcap_b4_theme', array(
	...
	'section'  => 'colors',
	'type'     => 'color',
    'label' => esc_html__( 'Links & Buttons Color', 'wpcap-b4' ),
    'default'  => '#007bff',
    'output'   => array(
        array(
...
WPCAP_B4_Kirki::add_field( 'wpcap_b4_theme', array(
	...
	'label'    => esc_html__( 'Links & Buttons Hover Color', 'wpcap-b4' ),
	'section'  => 'colors',
	'type'     => 'color',
    'default'  => '#0069d9',
    'output'   => array(
...
WPCAP_B4_Kirki::add_field( 'wpcap_b4_theme', array(
	...
	'label'    => esc_html__( 'Footer Background Color', 'wpcap-b4' ),
	'section'  => 'colors',
	'type'     => 'color',
    'default'  => '#ffffff',
    'output'   => array(
...
WPCAP_B4_Kirki::add_field( 'wpcap_b4_theme', array(
	...
	'label'    => esc_html__( 'Footer Text Color', 'wpcap-b4' ),
	'section'  => 'colors',
	'type'     => 'color',
    'default'  => '#6c757d',
    'output'   => array(
...
WPCAP_B4_Kirki::add_field( 'wpcap_b4_theme', array(
	...
	'label'    => esc_html__( 'Footer Link Color', 'wpcap-b4' ),
	'section'  => 'colors',
	'type'     => 'color',
    'default'  => '#007bff',
    'output'   => array(
