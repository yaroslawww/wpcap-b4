...
<?php if ( $featured_query->have_posts() ) : ?>
    <div id="wpcapb4-posts-slider" class="carousel slide mt-3r rounded" data-ride="carousel">
        <ol class="carousel-indicators">
            <?php $post_counter = 0; ?>
            <?php while ( $featured_query->have_posts() ) : $featured_query->the_post(); ?>
                <li data-target="#wpcapb4-posts-slider" data-slide-to="<?php echo esc_attr( $post_counter ); ?>" class="<?php if ( $post_counter === 0 ) : echo "active"; endif; ?>"></li>
                <?php $post_counter++; ?>
            <?php endwhile; ?>
        </ol>
                ...
                <div class="carousel-item rounded <?php if ( $post_counter === 0 ) : echo "active"; endif; ?>">
                    ...
                    <div class="carousel-caption d-none d-md-flex align-items-end">
                        <div class="w-100 text-center mb-4">
                            <h5><?php the_title(); ?></h5>
                            <p><?php echo esc_html( wpcap_b4_get_short_excerpt( 20 ) ); ?></p>
                            <a href="<?php echo esc_url( get_permalink() ); ?>" class="btn btn-primary btn-sm"><?php esc_html_e( 'Continue Reading', 'wpcap-b4' ); ?> <small class="oi oi-chevron-right ml-1"></small></a>
                        </div>
                    </div>
                </div>
                <?php $post_counter++; ?>
        ...
        <a class="carousel-control-prev" href="#wpcapb4-posts-slider" role="button" data-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="sr-only"><?php esc_html_e( 'Previous', 'wpcap-b4' ); ?></span>
        </a>
        <a class="carousel-control-next" href="#wpcapb4-posts-slider" role="button" data-slide="next">
            <span class="carousel-control-next-icon" aria-hidden="true"></span>
            <span class="sr-only"><?php esc_html_e( 'Next', 'wpcap-b4' ); ?></span>
        </a>
    </div>
<?php endif; ?>
